...
pinMode(relaypass,OUTPUT);
 ...
 //turn on the timer clock in the power management controller
  ...
  pmc_enable_periph_clk(ID_TC4); //Timer clock 4 ISR-> TC1 

  //we want wavesel 01 with RC 
  TC_Configure(TC1,1,TC_CMR_WAVE|TC_CMR_WAVSEL_UP_RC|TC_CMR_TCCLKS_TIMER_CLOCK2);
  TC_SetRC(TC1, 1, 238); // sets <> 44.1 Khz interrupt rate 10.5Mhz/44.1Khz = 238.09
  TC_Start(TC1, 1); //start timer
...
void TC4_Handler() //44.1KHz timer interrupt
{
